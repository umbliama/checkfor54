                    ...
                    <template v-if="activeTab == 'services'">
                        ...
                        >
                            ...
                            >
                                ...
                                {{equip.equipment.id}}
                                    <Link
                                        v-if="equip.equipment.directory === null"
                                        :href="
                                            '/directory/equipment/' +
                                            equip.equipment.id
                                        "
                            ...
                            <div
                                v-if="equip.subRows > 0"
                                v-for="item in equip.subRows -
                                equip.service_subs.length"
