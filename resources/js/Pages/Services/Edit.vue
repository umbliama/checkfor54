                        ...
                        <div v-if="serviceEquip.length > 0" v-for="(equip, index) in serviceEquip">
                            ...
                            <div>
                                ...
                                <div v-for="subequip in equip.service_subs"
                                    ...
                                    <div class="shrink-0 flex items-center w-[8.97%]">
                                        <input v-model="subequip.shipping_date" type="date"
                                            class="block w-full h-full py-2.5 px-2 bg-transparent"
                                            onclick="this.showPicker()" />
                                    </div>
                                    <div class="shrink-0 flex items-center w-[8.97%]">
                                        <input v-model="subequip.period_start_date" type="date"
                                            class="block w-full h-full py-2.5 px-2 bg-transparent"
                                            onclick="this.showPicker()" />
                                    </div>
                                    <div class="shrink-0 flex items-center w-[8.97%]">
                                        <input v-model="subequip.store" type="text"
                                            class="block w-full h-full py-2.5 px-2 bg-transparent" />
                                    </div>
                                    <div class="shrink-0 flex items-center w-[8.97%]">
                                        <input v-model="subequip.operating" type="text"
                                            class="block w-full h-full py-2.5 px-2 bg-transparent" />
                                    </div>
                                    <div class="shrink-0 flex items-center w-[8.97%]">
                                        <input v-model="subequip.period_end_date" type="date"
                                            class="block w-full h-full py-2.5 px-2 bg-transparent"
                                            onclick="this.showPicker()" />
                                    </div>
                                    <div class="shrink-0 flex items-center w-[8.97%]">
                                        <input v-model="subequip.return_date" type="date"
                                            class="block w-full h-full py-2.5 px-2 bg-transparent"
                                            onclick="this.showPicker()" />
                                    </div>
                                    <div class="shrink-0 flex items-center w-[8.97%] ">
                                    ...
                                    <div class="shrink-0 flex items-center w-[8.97%]">
                                        <input v-model="subequip.income" readonly="readonly" type="text"
                                            class="block w-full h-full py-2.5 px-2 bg-transparent" />
                                        <span class="shrink-0 inline-block mr-2">₽</span>
                                    </div>
                                    <div class="shrink-0 flex items-center w-[100px] py-2.5 px-2">
