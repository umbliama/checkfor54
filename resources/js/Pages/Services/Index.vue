...
<template>
    <AuthenticatedLayout>
        ...
        <div class="p-5">
                ...
                <div class="min-w-[1136px] text-xs">
                    ...
                    <template v-for="(service, index) in filterDatesInActive()" :key="service.id">
                        <div
                                    ...
                                    <PopoverPortal>
                                        <PopoverContent align="start"
                                            ...
                                            <template v-else>
                                                ...
                                                <PopoverClose>
                                                    <button class="inline-block mt-2 font-bold text-xs text-violet-full"
                            ...
                            <div class="shrink-0 flex items-center w-[14.08%] py-2.5 px-2">{{ service.shipping_date ??
                                '-' }}</div>
                            <div
                                class="shrink-0 flex items-center w-[calc(100%-44px-15.84%-14.08%-14.08%-100px)] py-2.5 px-2">
                                {{ service.commentary
            ...
            <pagination ref="pagination_el" :current-page="props.services.current_page"
                :total-pages="props.services.last_page" :total-count="props.services.total"
                :next-page-url="props.services.next_page_url" :links="props.services.links"
                :prev-page-url="props.services.prev_page_url" class="mt-5 bg-bg1" />
        </div>
