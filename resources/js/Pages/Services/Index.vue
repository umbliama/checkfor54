    ...
    <AuthenticatedLayout>
        ...
        <div class="p-5">
            <div class="relative mt-5 text-sm">
                ...
                >
                    <li
                        ...
                        :class="{ '!border-[#001D6C] text-[#001D6C]': getMonth === key }"
            ...
            <div class="flex items-center justify-between mt-6">
                <h3 class="font-bold text-gray1">Список открытых аренд:</h3>
            ...
            <div v-if="!selectedActive" class="w-full max-w-full mt-6 bg-bg2 overflow-x-auto border border-gray3">
                <div class="min-w-[1136px] text-xs">
                    <div class="flex font-bold border-b border-b-gray3 [&>*:not(:first-child)]:border-l [&>*:not(:first-child)]:border-l-gray3">
                        ...
                        <div class="shrink-0 flex items-center w-[14.08%] py-2.5 px-2">Дата отгрузки</div>
                    ...
                    <template v-for="(service, index) in filterDatesInActive()" :key="service.id">
                        <div class="flex border-b border-b-gray3 [&>*:not(:first-child)]:border-l [&>*:not(:first-child)]:border-l-gray3 break-all">
                            <div class="shrink-0 flex items-center w-[44px] py-2.5 px-2">
                                <PopoverRoot>
                                    <PopoverTrigger>
                                        <svg v-if="service.hyperlink" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                ...
                                                                >
                                                                    ...
                                                                    <PopoverClose>
                                                                        <button
                                                                            ...
                                                                            @click="submitHyperlink(service.id, form.hyperlink)"
                                                                        >Сохранить</button>
                                                                    </PopoverClose>
                                                                </PopoverContent>
                                                            </PopoverPortal>
                            ...
                            <div class="shrink-0 flex items-center justify-between w-[15.84%] py-2.5 px-2">
                                ...
                                >
                                    <svg class="block" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M3.375 6C5.625 10.875 12.375 10.875 14.625 6" stroke="#644DED" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M12.6122 8.4881L14.625 11.25" stroke="#644DED" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M9 9.65625V12.375" stroke="#644DED" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M5.38787 8.4881L3.375 11.25" stroke="#644DED" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                                    <svg
                                        :class="{ '-rotate-90': showSubservices[index] }"
                                        class="block ml-1 transition-all"
                                        width="18" height="18" viewBox="0 0 18 18"
                                        fill="none" xmlns="http://www.w3.org/2000/svg"
                                    >
                                        <path d="M10.5 12L7.31802 8.81802L10.5 5.63604" stroke="#644DED" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                                </button>
                            </div>
                            <div class="shrink-0 flex items-center w-[14.08%] py-2.5 px-2">{{ service.shipping_date ?? '-' }}</div>
                            <div class="shrink-0 flex items-center w-[calc(100%-44px-15.84%-14.08%-14.08%-100px)] py-2.5 px-2">{{ service.commentary ?? '-' }}</div>
                            <div class="shrink-0 flex items-center w-[14.08%] py-2.5 px-2">{{ service.income ?? '-' }} ₽</div>
                            <div class="shrink-0 flex items-center w-[100px] py-2.5 px-2">
                                <Link :href="route('directory.index',{type:'services', id:service.id})" class="mr-3.5">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            >
                                                <DropdownMenuItem>
                                                    <button
                                                        ...
                                                        @click="toggleSubservice(index)"
                                                    >
                                                        {{ showSubservices[index] ? 'Скрыть' : 'Отобразить' }} оборудование
                                                        <svg class="block ml-2" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M14 8C14 11.3138 11.3138 14 8 14C4.68616 14 2 11.3138 2 8C2 4.68625 4.68616 2 8 2C11.3138 2 14 4.68625 14 8ZM6.70239 6.65747H8.82398V11.1769C8.82398 11.6144 8.46933 11.969 8.03186 11.969C7.59439 11.969 7.23975 11.6144 7.23975 11.1769V8.06226H6.70239C6.31447 8.06226 6 7.74778 6 7.35986C6 6.97194 6.31447 6.65747 6.70239 6.65747ZM7.00977 4.93247C7.00977 4.80778 7.03192 4.69149 7.07587 4.58359C7.12345 4.47236 7.18773 4.37629 7.26909 4.29539C7.35044 4.21449 7.44524 4.15048 7.55383 4.10326C7.60323 4.0824 7.65408 4.06615 7.70674 4.0545C7.77357 4.03987 7.84294 4.03247 7.91485 4.03247C8.03688 4.03247 8.15202 4.05604 8.26061 4.10326C8.29003 4.11599 8.31836 4.12998 8.3456 4.14515C8.41933 4.18623 8.4858 4.23634 8.54536 4.29539C8.62671 4.37629 8.691 4.47236 8.73858 4.58359C8.76328 4.63984 8.7818 4.69835 8.79342 4.75912C8.80432 4.815 8.80977 4.87279 8.80977 4.93247C8.80977 4.99965 8.80287 5.06492 8.78906 5.12822C8.77744 5.18239 8.76037 5.23512 8.73858 5.2864C8.691 5.3943 8.62671 5.48865 8.54536 5.56955C8.50359 5.61099 8.45856 5.64801 8.40989 5.6806C8.3634 5.71157 8.31364 5.73866 8.26061 5.76168C8.15202 5.80891 8.03688 5.83247 7.91485 5.83247C7.85129 5.83247 7.78991 5.82678 7.73071 5.81532C7.66933 5.80358 7.61049 5.7857 7.55383 5.76168C7.44524 5.71446 7.35044 5.65045 7.26909 5.56955C7.18773 5.48865 7.12345 5.3943 7.07587 5.2864C7.03192 5.17517 7.00977 5.05716 7.00977 4.93247Z" fill="#464F60"/>
                                                        </svg>
                                                    </button>
                                                ...
                                                <DropdownMenuItem>
                                                    ...
                                                    >
                                                        Удалить
                                                        <svg class="block ml-2" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M4.75 3.75V4.25H2.75C2.33579 4.25 2 4.58579 2 5C2 5.41421 2.33579 5.75 2.75 5.75H3.51389L3.89504 12.6109C3.95392 13.6708 4.8305 14.5 5.89196 14.5H10.108C11.1695 14.5 12.0461 13.6708 12.1049 12.6109L12.4861 5.75H13.25C13.6642 5.75 14 5.41421 14 5C14 4.58579 13.6642 4.25 13.25 4.25H11.25V3.75C11.25 2.50736 10.2426 1.5 9 1.5H7C5.75736 1.5 4.75 2.50736 4.75 3.75ZM7 3C6.58579 3 6.25 3.33579 6.25 3.75V4.25H9.75V3.75C9.75 3.33579 9.41421 3 9 3H7ZM7.25 7.75C7.25 7.33579 6.91421 7 6.5 7C6.08579 7 5.75 7.33579 5.75 7.75V12.25C5.75 12.6642 6.08579 13 6.5 13C6.91421 13 7.25 12.6642 7.25 12.25V7.75ZM10.25 7.75C10.25 7.33579 9.91421 7 9.5 7C9.08579 7 8.75 7.33579 8.75 7.75V12.25C8.75 12.6642 9.08579 13 9.5 13C9.91421 13 10.25 12.6642 10.25 12.25V7.75Z" fill="#DA1E28"/>
                                                        </svg>
                                                    </Link>
                                                </DropdownMenuItem>
                                            </DropdownMenuContent>
                        ...
                        <div
                            v-if="service.subservices.length"
                            ref="subservicesEls"
                            style="transition: .3s;"
                        ...
                        >
                            ...
                            >
                                                                ...
                                                                <PopoverPortal>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <PopoverClose>
                                                                            <button
                                                                                class="inline-block mt-2 font-bold text-xs text-violet-full"
                                                                                @click="submitHyperlink(subservice.id, form.hyperlink)"
                                                                            >Сохранить</button>
                                                                        </PopoverClose>
                                                                    </PopoverContent>
                                                                </PopoverPortal>
                                ...
                                <div class="shrink-0 flex items-center justify-between w-[15.84%] py-2.5 px-2 !border-l-violet-full">
                                    {{ subservice.equipment.series ?? '-' }}
                                </div>
                                <div class="shrink-0 flex items-center w-[14.08%] py-2.5 px-2">{{ subservice.shipping_date ?? '-' }}</div>
                                <div class="shrink-0 flex items-center w-[calc(100%-44px-15.84%-14.08%-14.08%-100px)] py-2.5 px-2">{{ subservice.commentary ?? '-' }}</div>
                                <div class="shrink-0 flex items-center w-[14.08%] py-2.5 px-2">{{ subservice.income ?? '-' }} ₽</div>
                                <div class="shrink-0 flex items-center w-[100px] py-2.5 px-2">
                                    <Link :href="route('directory.index',{type:'services', id:service.id})" class="mr-3.5">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <DropdownMenuPortal>
                                            <transition name="fade">
                                                ...
                                                >
                                                    <DropdownMenuItem>
                                                        <Link
                                                            :href="route('services.edit', subservice.id)"
                                                            class="inline-flex items-center py-1 px-2 rounded hover:bg-my-gray transition-all"
                                                        >
                                                            Редактировать
                                                            <svg class="block ml-2" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <DropdownMenuItem>
                                                        <Link
                                                            :href="route('services.destroy', subservice.id)"
                                                            methods="delete"
                                                            class="inline-flex items-center py-1 px-2 rounded text-danger hover:bg-my-gray transition-all"
                                                        >
                                                            Удалить
            ...
            {{ props.services.next_page_url }}

            <pagination
                ref="pagination_el"
                :current-page="props.services.current_page"
                :total-pages="props.services.last_page"
                :total-count="props.services.total"
                :next-page-url="props.services.next_page_url"
                :links="props.services.links"
                :prev-page-url="props.services.prev_page_url"
                class="mt-5 bg-bg1"
            />
        </div>
