            ...
            <div class="w-full max-w-full mt-6 bg-bg2 overflow-x-auto border border-gray3">
                <div class="min-w-[1050px] text-xs">
                    ...
                    <AccordionRoot type="multiple" :collapsible="true">
                        <AccordionItem v-for="(service, index) in sales.data" :value="'item-' + index">
                            <AccordionHeader
                                                ...
                                                <PopoverRoot v-else>
                                                    ...
                                                    <PopoverPortal>
                                                        <PopoverContent side="bottom" align="end"
                                                            class="w-[300px] p-4 rounded-lg text-sm bg-white shadow-lg">
                                                            <div>Комментарий:</div>
                                                            <p class="mt-2.5 text-xs">{{ subservice.directory.commentary }}</p>
                                                            <div v-for="file in subservice.directory.files" class="mt-3 p-4 bg-bg1 text-xs">
                                                                <div class="flex items-center max-w-full">
                                                                    <span
                                                                ...
                                                                <PopoverPortal>
                                                                    <PopoverContent side="bottom" align="end"
                                                                        ...
                                                                        <p class="mt-2.5 text-xs">Далеко-далеко за
                                                                            ...
                                                                            гласных и согласных
                                                                            живут рыбные тексты. Страна если бросил, он
                                                                            всемогущая запятых
                                                                            грамматики себя ipsum
