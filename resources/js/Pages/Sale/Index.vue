            ...
            if (raw[key]) {
                ...
                for (const service of servicesArray) {
                    if (service && service.price) {
                        ...
                        result[contragentId] += service.price;
                    }
                }
            }
...
<template>
    <AuthenticatedLayout>
                                    ...
                                    <AccordionItem v-for="subservice in service.sales" :value="'item-' + subservice.id">
                                        <AccordionHeader
                                            ...
                                            <div class="shrink-0 flex items-center w-[14.08%]">
                                                <input v-model="subservice.sale_date" type="date"
                                            ...
                                            <div class="shrink-0 flex items-center justify-end w-[14.08%]">
                                                <input v-model="subservice.price" type="text"
                                                    class="block w-full h-full px-2 bg-transparent" />
                                            </div>
                                            <div class="shrink-0 flex items-center w-[100px] py-2.5 px-2">
                                                <Link v-if="subservice.directory === null"
                                                    :href="'/directory/sale/' + subservice.id" class="mr-3.5">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                                        d="M4.125 5.25C3.50368 5.25 3 5.75368 3 6.375V17.625C3 18.2463 3.50368 18.75 4.125 18.75H19.875C20.4963 18.75 21 18.2463 21 17.625V6.375C21 5.75368 20.4963 5.25 19.875 5.25H4.125ZM1.5 6.375C1.5 4.92525 2.67525 3.75 4.125 3.75H19.875C21.3247 3.75 22.5 4.92525 22.5 6.375V17.625C22.5 19.0747 21.3247 20.25 19.875 20.25H4.125C2.67525 20.25 1.5 19.0747 1.5 17.625V6.375Z"
                                                ...
                                                <PopoverRoot v-else>
                                                    ...
                                                    <PopoverPortal>
                                                        <PopoverContent side="bottom" align="end"
                                                            class="w-[300px] p-4 rounded-lg text-sm bg-white shadow-lg">
                                                            <div>Комментарий:</div>
                                                            <p class="mt-2.5 text-xs">{{ subservice.directory.commentary
                                                                }}</p>
                                                            <div v-for="file in subservice.directory.files"
                                                    ...
                                                    <DropdownMenuPortal>
                                                        <transition name="fade">
                                                            <DropdownMenuContent
                                                                ...
                                                                :side-offset="5" align="end">
                                                                <DropdownMenuItem>
                                                                    <Link :href="`/sale/edit/${subservice.id}`"
                                                                        class="inline-flex items-center py-1 px-2 rounded text-danger hover:bg-my-gray transition-all">
                                                                    Редактировать
                                                                    <svg class="block ml-2" width="16" height="16"
                                                                        viewBox="0 0 16 16" fill="none"
                                                                ...
                                                                <DropdownMenuItem>
                                                                    <Link :href="`/sale/delete/${subservice.id}`"
                                                                        method="DELETE"
                                                                        class="inline-flex items-center py-1 px-2 rounded text-danger hover:bg-my-gray transition-all">
                                                                    Удалить
                                                                    <svg class="block ml-2" width="16" height="16"
                                        ...
                                        <AccordionContent
                                            ...
                                            <!-- 3 уровень -->
                                            <AccordionRoot type="multiple" :collapsible="true">
                                                <AccordionItem v-for="equip in subservice.sale_equipment"
                                                    :value="'item-' + equip.id">
                                                    <AccordionHeader
                                                        ...
                                                        <div
                                                            class="shrink-0 flex items-center w-[calc(100%-44px-15.84%-14.08%-14.08%-100px)]">
                                                            <input v-model="equip.commentary" type="text"
                                                                class="block w-full h-full px-2 bg-transparent" />
                                                        </div>
                                                        <div class="shrink-0 flex items-center justify-end w-[14.08%]">
                                                            <input v-model="equip.price" type="text"
                                                                class="block w-full h-full px-2 bg-transparent" />
                                                        </div>
                                                        <div class="shrink-0 flex items-center w-[100px] py-2.5 px-2">
                                                    ...
                                                    <AccordionContent
                                                        ...
                                                        <div v-for="subequip in equip.subequipment"
                                                            ...
                                                            <div
                                                                ...
                                                                <input v-model="subequip.price" type="text"
                                                                    class="block w-full h-full px-2 bg-transparent" />
                                                            </div>
                                                            <div
        ...
        <SaleContragentEditDialog v-model="is_edit_dialog_open" :contragent="contragent_to_edit" />
