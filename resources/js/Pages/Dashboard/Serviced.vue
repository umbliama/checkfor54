                    ...
                    <div class="min-w-[1144px] text-xs">
                        ...
                        <div
                            ...
                            <div class="shrink-0 flex items-center w-[9.96%] py-2.5 px-2">
                                ...
                                <span class="line-clamp-2">Some</span>
                            </div>
                            <div :class="{ 'bg-[#644DED] bg-opacity-10': true }"
                                    class="shrink-0 flex items-center w-[9.96%] py-2.5 px-2">as212
                            </div>
                            <div class="shrink-0 flex items-center w-[5.15%] py-2.5 px-2">
                                12
                            </div>
                            <div class="shrink-0 flex items-center w-[4.89%] py-2.5 px-2">2
                            </div>
                            <div class="shrink-0 flex items-center w-[5.15%] py-2.5 px-2">11
                            </div>
                            ...
                            <div class="shrink-0 flex items-center w-[8.04%] py-2.5 px-2">12312 ₽
                            </div>
