...
const updateUrl = () => {
    ...
    Object.keys(params).length && router.replace(route('serviced', params));
};

const removeParams = () => {
    router.get(route('serviced'))
}
...
<template>
    <AuthenticatedLayout>
        <DashboardToolbar dashboard-page-type="serviced" />
        ...
        <div class="p-5">
            ...
            <div class="relative mt-5 text-sm">
                ...
                <ul
                    ...
                    <li @click="setLocationId(0)" :class="{ '!border-[#001D6C] text-[#001D6C]': chosenLocation === 0 }"
                                    ...
                                    <PopoverPortal>
                                        <PopoverContent side="bottom" align="end"
                                            ...
                                            <p class="mt-2.5 text-xs">Далеко-далеко за словесными горами в стране
                                                гласных и
                                                согласных живут рыбные тексты. Страна если бросил, он всемогущая запятых
                                                грамматики
                                                себя ipsum точках, несколько меня строчка маленькая страну предупреждал
                                                которой раз
                                                проектах. Ему выйти составитель дал то ...</p>
                                            <div class="mt-3 p-4 bg-bg1 text-xs">
                                                <div class="flex items-center max-w-full">
                                                    <span class="grow block mr-auto text-ellipsis overflow-hidden">Some
                                                        file
                                                        name</span>
                                    ...
                                    <DropdownMenuPortal>
                                        <transition name="fade">
                                            <DropdownMenuContent
                                                ...
                                                <DropdownMenuItem>
                                                    <Link :href="route('equip.destroy', 1)" method="DELETE"
