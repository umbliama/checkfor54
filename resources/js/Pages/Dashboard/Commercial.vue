            ...
            <div class="grid grid-cols-1 gap-4 lg:grid-cols-4 xl:grid-cols-6 lg:gap-6">
                <div class="p-4 border border-[#DDE1E6] bg-white">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="font-bold text-xl lg:text-2xl">{{ KPcount }}</div>
                        <div
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center h-6 px-2 rounded-full text-sm border border-gray1 bg-bg1">
                            <svg class="inline-block mr-1.5" width="17" height="16" viewBox="0 0 17 16" fill="none"
                                ...
                                <path
                                    d="M8.78564 4.00004L4.78564 8.00004M8.78564 12.3334V4.00004V12.3334ZM8.78564 4.00004L12.7856 8.00004L8.78564 4.00004Z"
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center h-6 px-2 rounded-full text-sm border border-gray1 bg-bg1">
                            <svg class="inline-block mr-1.5" width="17" height="16" viewBox="0 0 17 16" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M8.8811 12L12.8811 7.99996M8.8811 3.66663V12V3.66663ZM8.8811 12L4.8811 7.99996L8.8811 12Z"
                                        ...
                                        <PopoverRoot v-else>
                                            ...
                                            <PopoverPortal>
                                                <PopoverContent side="bottom" align="end"
                                                    class="w-[300px] p-4 rounded-lg text-sm bg-white shadow-lg">
                                                    <div>Комментарий:</div>
                                                    <p class="mt-2.5 text-xs">Далеко-далеко за словесными горами в
                                                        стране гласных и согласных живут рыбные тексты. Страна если
                                                        бросил, он всемогущая запятых грамматики себя ipsum точках,
                                                        несколько меня строчка маленькая страну предупреждал которой раз
                                                        проектах. Ему выйти составитель дал то ...</p>
                                                    <div class="mt-3 p-4 bg-bg1 text-xs">
                                                        <div class="flex items-center max-w-full">
                                                            <span
                                                                class="grow block mr-auto text-ellipsis overflow-hidden">Some
