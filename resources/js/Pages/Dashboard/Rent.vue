        ...
        <div class="p-5">
            ...
            <div class="flex w-full mt-5">
                ...
                <div class="w-full lg:w-[calc(100%-168px-14px)]">
                    <div class="items-center justify-between mb-2 py-3 px-2.5 text-base border border-[#EEEEF2] lg:flex">
                        <div class="font-bold text-xs">ООО Иргъма:</div>
                    ...
                    <div class="space-y-6">
                        <AccordionRoot type="multiple" :collapsible="true">
                            <AccordionItem v-for="(services, contragentId, index) in rented_services_grouped" :value="'head-item-'+index" class="mt-3">
                                ...
                                <AccordionHeader class="items-center justify-between py-3 px-2.5 text-base border border-[#EEEEF2] lg:flex">
                                    <div class="flex items-center font-bold text-xs">
                                        17.03.2024
                                        <AccordionTrigger class="group ml-1.5">
                                            <svg class="group-data-[state=open]:hidden" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <svg class="hidden group-data-[state=open]:block" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M2.27198 9.29131C2.27198 8.95993 2.54061 8.69131 2.87198 8.69131H14.6285C14.9599 8.69131 15.2285 8.95993 15.2285 9.29131C15.2285 9.62268 14.9599 9.8913 14.6285 9.89131H2.87198C2.54061 9.8913 2.27198 9.62268 2.27198 9.29131Z" fill="#242533"/>
                                            </svg>
                                        </AccordionTrigger>
                                    </div>
                                    <div class="mt-2 font-medium text-[#484964] lg:mt-0">
