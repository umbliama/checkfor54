                ...
                <div v-if="selectedCategory == 1"
                    ...
                    <div class="min-w-[1280px] text-xs">
                        <div
                            ...
                            <div class="shrink-0 flex items-center justify-center w-[calc(100%-9.96%-8.8%-5.15%-4.89%-4.89%-5.15%-6%-6.11%-6.11%-8.56%-6%-6%-9.96%-70px)] py-2.5 px-2">Изготовлен
                            </div>
                            <div class="shrink-0 flex items-center justify-center w-[9.96%] py-2.5 px-2">Состояние</div>
                            <div class="shrink-0 flex items-center justify-center w-[9.96%] py-2.5 px-2">Местонахождение</div>
                        ...
                        <template v-for="item in sortedEquipment">
                            ...
                            :class="{'bg-gray-200' : item.location_id === -1}"
                                ...
                                <div class="shrink-0 flex items-center w-[6.1%] py-2.5 px-2">{{ item.narabotka_ds }} 
                                </div>
