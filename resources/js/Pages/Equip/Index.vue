    ...
    <AuthenticatedLayout>
        ...
        <div class="p-5">
            ...
            <div v-if="selectedCategory" class="mt-5">
                            ...
                            <div
                                ...
                                <div class="shrink-0 flex items-center w-[9.96%] py-2.5 px-2">
                                    <div class="mr-2">
                                        <PopoverRoot>
                                            <PopoverTrigger>
                                                <svg v-if="item.hyperlink" width="24" height="24" viewBox="0 0 24 24"
                                        ...
                                        <!--                                        <button v-else type="button" @click="toggleInputLocationShown(true, item.id)">
                ...
                <pagination ref="pagination_el" :current-page="props.equipment.current_page"
                    :total-pages="props.equipment.last_page" :total-count="props.equipment.total"
                    :next-page-url="props.equipment.next_page_url" :links="props.equipment.links"
                    :prev-page-url="props.equipment.prev_page_url" class="mt-5 bg-bg1" />
