...
import { Menu, MenuItems, MenuItem, MenuButton, Popover, PopoverButton, PopoverPanel } from '@headlessui/vue'
                    ...
                    <div class="mt-6 flex items-center">
                        <ul
                            ...
                            <li class="text-my-nav-text text-md w-full sm:py-2"
                                ...
                                <Link class="flex justify-around" :href="route('equip.index')">
                                {{ item.name }}
                                <span
                        ...
                        <ul
                            ...
                            <li class="text-my-nav-text text-lg sm:py-2 w-full"
                                ...
                                <Link class="flex justify-around"
                                    :href="route('equip.index', { size_id: item.id, category_id: selectedCategory })">
                                {{ item.name }}
                                <span
                                    class="ml-1 rounded-2xl text-sm flex items-center px-3 py-1 text-white bg-gray-500 ">
