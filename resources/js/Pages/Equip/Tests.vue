...
<template>
    <AuthenticatedLayout>
        ...
        <div class="container mt-5 md:mx-auto">
            <nav class="rounded-xl bg-my-gray">
            ...
            <div class="flex">
                <ul class="flex lg:mt-10 flex-col lg:flex sm:hidden">
            ...
            <div class="overflow-x-auto lg:p-4 lg:pb-0 sm:pb-20 ">
                <table class="table-auto w-full border border-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            <th class="border px-4 py-2 text-left text-gray-600">Дата испытания</th>
                            ...
                            <th class="border px-4 py-2 text-left text-gray-600">Описание</th>
                            <th class="border px-4 py-2 text-left text-gray-600">Расход</th>
                            <th colspan="2" class="border m-auto  px-4 py-2 text-left text-gray-600"><svg width="24"
