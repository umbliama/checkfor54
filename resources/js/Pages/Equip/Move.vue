...
const closeMove = (id, send_date, departure_date,
    from,
    to,
    reason,
    expense,
    ...
    size_id,
    series) => {
    router.post(route('equip.closeMove'), {
        equipment_id: id,
        send_date: send_date,
...
<template>
    <AuthenticatedLayout>
                    ...
                    <div class="w-full max-w-full mt-2.5 bg-bg2 overflow-x-auto border border-gray3">
                        <div class="min-w-[1050px] text-xs">
                            <div
                                ...
                                <div
                                    class="shrink-0 flex items-center w-[calc(100%-12.14%-10.6%-10.6%-10.6%-8.94%-50px)] py-2.5 px-2">
                                    Причина вывоза</div>
                            ...
                            <div
                                ...
                                <div
                                    class="shrink-0 flex items-center w-[calc(100%-12.14%-10.6%-10.6%-10.6%-8.94%-50px)]">
                        ...
                        <div class="w-full max-w-full mt-2.5 bg-bg2 overflow-x-auto border border-gray3">
                            <div class="min-w-[1050px] text-xs">
                                <div
                                    ...
                                    <div class="shrink-0 flex items-center w-[10.6%] py-2.5 px-2">Дата прибытия</div>
                                    <div
                                        class="shrink-0 flex items-center w-[calc(100%-12.14%-10.6%-10.6%-10.6%-8.94%-100px)] py-2.5 px-2">
                                        Причина вывоза</div>
                                    <div class="shrink-0 flex items-center justify-center w-[8.94%] py-2.5 px-2">Расход
                                    </div>
                                ...
                                <template v-for="move in moves">
                                    <div
                                        ...
                                        <div
                                            ...
                                            {{ move.send_date || '-' }}</div>
                                        <div class="shrink-0 flex items-center w-[10.6%] py-2.5 px-2">{{
                                            getLocationName(move.from) || '-' }}</div>
                                        <div class="shrink-0 flex items-center w-[10.6%] py-2.5 px-2">{{
                                            getLocationName(move.to) || '-' }}</div>
                                        <div class="shrink-0 flex items-center w-[10.6%] py-2.5 px-2">{{
                                            move.departure_date || '-' }}</div>
                                        <div
                                            class="shrink-0 flex items-center w-[calc(100%-12.14%-10.6%-10.6%-10.6%-8.94%-100px)] py-2.5 px-2">
                                            {{ move.reason || '-' }}</div>
                                        <div class="shrink-0 flex items-center justify-center w-[8.94%] py-2.5 px-2">{{
                                            move.expense || '-' }} ₽</div>
                                        <div class="shrink-0 flex items-center w-[100px] py-2.5 px-2">
                                            <button v-if="move.isLocked" class="mr-3.5">
                                            ...
                                            <button
                                                @click="closeMove(move.id, move.send_date, move.departure_date, move.from, move.to, move.reason, move.expense)"
                                                v-else class="mr-3.5">
                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                            ...
                                            <PopoverRoot v-else>
                                                ...
                                                <PopoverPortal>
                                                    <PopoverContent side="bottom" align="end"
                                                        ...
                                                        <div v-for="file in move.directory.files"
                                                        ...
                                                        <Link :href="'/directory/move/' + move.id"
        ...
        <EquipMoveEditDialog v-model="is_dialog_open" :locations="props.equipment_locations" :move="move_to_edit" />
    </AuthenticatedLayout>
