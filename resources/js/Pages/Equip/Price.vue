                ...
                <table class="table-auto bg-table-gray w-full ">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <select v-model="form.contragent_id"  name="" class="bg-table-gray w-full border-none" id="">
                                    <option value="">Выберите</option>
                                    <option v-for="item in contragents" :value="item.id">{{ item.name }}</option>
                                </select>
                            </td>

                            <td><input v-model="form.store_date" type="date" class="input bg-table-gray  border-none" /></td>
                            <td><input v-model="form.notes" type="text" class="input bg-table-gray  border-none" /></td>
                            <td><input v-model="form.price" type="text" class="input bg-table-gray  border-none" /></td>
                            <td>
