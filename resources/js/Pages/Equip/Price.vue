...
<template>
    <AuthenticatedLayout>
        ...
        <div class="container mt-5 md:mx-auto">
            ...
            <div v-if="getTabActive == 'price'" class="p-4 overflow-x-auto">
                <div class="grid grid-cols-6 gap-4 bg-table-gray w-full p-4">
                    <!-- Grid Header -->
                    <div class="flex items-center bg-violet">
                        <a href="">
                    ...
                    <div class="p-4">Наименование</div>
                    <div class="p-4">Дата</div>
                    <div class="p-4">Примечание</div>
                    <div class="p-4">Цена хранения</div>
                    <div class="p-4">...</div> <!-- Add other header items as needed -->

                    <!-- Repeat Grid Row for each data item -->
                    ...
                    <div>
                        <select v-model="form.contragent_id" class="bg-table-gray w-full border-none">
                            <option value="">Выберите</option>
                            <option v-for="item in contragents" :value="item.id">{{ item.name }}</option>
                        </select>
                    </div>
                    <div><input v-model="form.store_date" type="date" class="input bg-table-gray border-none" /></div>
                    <div><input v-model="form.notes" type="text" class="input bg-table-gray border-none" /></div>
                    <div><input v-model="form.price" type="text" class="input bg-table-gray border-none" /></div>
