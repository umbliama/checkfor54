    ...
    <AuthenticatedLayout>
        ...
        <div class="p-5">
            ...
            <div class="relative mt-5">
                ...
                <ul class="relative flex items-center w-full font-medium space-x-6 overflow-x-auto text-gray1">
                    <li
            ...
            <div v-if="props.prices.length" class="w-full max-w-full mt-2.5 bg-bg2 overflow-x-auto border border-gray3">
                <div class="min-w-[1050px] text-xs">
                    <div class="flex font-bold border-b border-b-gray3 [&>*:not(:first-child)]:border-l [&>*:not(:first-child)]:border-l-gray3">
                        <button
                            type="button"
                            class="shrink-0 flex items-center justify-center w-[44px] py-2.5 px-2 bg-violet-full/5"
                            @click="incRows"
                        >
                        ...
                        <div class="shrink-0 flex items-center w-[13.98%] py-2.5 px-2">Дата</div>
            ...
            <div v-if="props.archivedPrices.length" class="w-full max-w-full mt-2.5 bg-bg2 overflow-x-auto border border-gray3">
                <div class="min-w-[1050px] text-xs">
                    <div class="flex font-bold border-b border-b-gray3 [&>*:not(:first-child)]:border-l [&>*:not(:first-child)]:border-l-gray3">
                        <button
                            type="button"
                    ...
                    <div
                        v-for="(price, index) in sortedPricesArchived"
                        :key="index"
                        class="flex border-b border-b-gray3 [&>*:not(:first-child)]:border-l [&>*:not(:first-child)]:border-l-gray3"
                    >
                        <div class="shrink-0 flex items-center justify-center w-[44px] py-2.5 px-2">
        ...
        <div class="container mt-5 md:mx-auto">
            ...
            <div class="flex">
                <ul class="flex flex-col lg:flex  sm:hidden">
                    <li :class="{ 'bg-my-gray': seriesActive === series }" class="border-b-2  border-gray-200 px-2 py-4"
                        @click="setSeriesId(series)" v-for="series in equipmentSeries">{{ series }}
                    </li>
                </ul>
            ...
            <div v-if="getTabActive == 'price'" class="p-4 overflow-x-auto whitespace-nowrap">
                <div class="grid bg-table-gray grid-cols-[auto,1fr,1fr,1fr,auto,auto,auto]">
                    ...
                    <div class="col-span-1 text-table-heading font-robotoBold font-semibold p-4 text-left">Заказчик
                    </div>
                    <div @click="toggleSortBy('date')"
                         :class="{ 'bg-violet border-t-2 border-violet-full': sortBy === 'date' }"
                         class="col-span-1 text-table-heading font-robotoBold font-semibold p-4     text-left text-gray-500">
                        Дата
                    </div>
                    <div
                        class="col-span-1 text-table-heading font-robotoBold font-semibold p-4 text-left text-gray-500">
                    ...
                    <div
                        class="col-span-1 text-table-heading font-robotoBold font-semibold p-4 text-left font-semibold">
                        Цена хранения
                    </div>
                    <div
                        class="col-span-1 text-table-heading font-robotoBold font-semibold p-4 text-left font-semibold">
                    ...
                    <div
                        class="col-span-1 text-table-heading font-robotoBold font-semibold p-4 flex items-center justify-start space-x-2">
                    ...
                    <div v-if="getPriceRowsCount > 0" class="col-span-1 text-left text-gray-500 "><input
                        v-model="form.store_date" type="date">
                    </div>
                    <div v-if="getPriceRowsCount > 0" class="col-span-1 text-left text-gray-500"><input
                        v-model="form.notes" type="text"></div>
                    <div v-if="getPriceRowsCount > 0" class="col-span-1 text-left font-semibold"><input
                        v-model="form.store_price" type="text"></div>
                    <div v-if="getPriceRowsCount > 0" class="col-span-1 text-left font-semibold"><input
                        v-model="form.operation_price" type="text"></div>
                    ...
                    <template v-for="(price, index) in sortedPrices" :key="index">
                        ...
                        <div class="col-span-1 text-table-heading font-robotoBold p-4 text-left">
                            {{ price.contragent.name }}
                        </div>
                        <div class="col-span-1 text-table-heading font-robotoBold p-4 text-left text-gray-500 p-4"
                             :class="{ 'bg-violet': sortBy === 'date' }">{{ price.store_date }}
                        </div>
                        <div class="col-span-1 text-table-heading font-robotoBold p-4 text-left text-gray-500">
                            {{ price.notes }}
                        </div>
                        <div class="col-span-1 text-table-heading font-robotoBold p-4 text-left font-semibold">
                            {{ price.store_price }}
                        </div>
                        <div class="col-span-1 text-table-heading font-robotoBold p-4 text-left font-semibold">
                            {{ price.operation_price }}
                        ...
                        <div
                            class="col-span-1 text-table-heading font-robotoBold p-4 flex items-center justify-start space-x-2">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                      d="M4.125 5.25C3.50368 5.25 3 5.75368 3 6.375V17.625C3 18.2463 3.50368 18.75 4.125 18.75H19.875C20.4963 18.75 21 18.2463 21 17.625V6.375C21 5.75368 20.4963 5.25 19.875 5.25H4.125ZM1.5 6.375C1.5 4.92525 2.67525 3.75 4.125 3.75H19.875C21.3247 3.75 22.5 4.92525 22.5 6.375V17.625C22.5 19.0747 21.3247 20.25 19.875 20.25H4.125C2.67525 20.25 1.5 19.0747 1.5 17.625V6.375Z"
                                      fill="#21272A"/>
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                      d="M4.65802 7.03958C4.91232 6.71262 5.38353 6.65372 5.71049 6.90802L12 11.7999L18.2896 6.90802C18.6165 6.65372 19.0877 6.71262 19.342 7.03958C19.5964 7.36654 19.5375 7.83775 19.2105 8.09205L12.4605 13.342C12.1897 13.5527 11.8104 13.5527 11.5396 13.342L4.78958 8.09205C4.46262 7.83775 4.40372 7.36654 4.65802 7.03958Z"
                                      fill="#21272A"/>
                            </svg>
                        </div>
                ...
                <div class="pt-5 flex justify-end">
                    ...
                    <button @click="submit"
                            class="text-center bg-my-gray    justify-end  py-3 px-10 bg-gray-300 p">Сохранить
                    </button>
