...
function submitHyperlink(id, data) {
    router.post(`/equipment/repair/${id}/hyperlink`, {
        'hyperlink': data
    });
}
                                    ...
                                    <div
                                        ...
                                        <PopoverRoot>
                                            <PopoverTrigger
                                                ...
                                                <svg v-if="repair.hyperlink" width="24" height="24" viewBox="0 0 24 24"
                                                                ...
                                                                <PopoverRoot>
                                                                    ...
                                                                    <PopoverPortal>
                                                                        <PopoverContent align="start"
                                                                            ...
                                                                            <UiField v-model="hyperlink_form.hyperlink"
                                                                                :inp-attrs="{ placeholder: 'www.site.ru' }"
                                                                                size="sm" />
                                                                            <PopoverClose>
                                                                                <button
                                                                                    class="inline-block mt-2 font-bold text-xs text-violet-full"
                                                                                    @click="submitHyperlink(repair.id, hyperlink_form.hyperlink)">Сохранить</button>
                                                                            </PopoverClose>
                                                                        </PopoverContent>
                                                                    </PopoverPortal>
                                                                </PopoverRoot>
                                        ...
                                        <div class="shrink-0 flex items-center w-[8.94%] py-2.5 px-2">{{
                                            getLocationName(repair.location_id) || '-' }}
                                        </div>
                                        <div
                                            class="shrink-0 flex items-center w-[calc(100%-12.14%-8.94%-8.94%-50px)] py-2.5 px-2">
                                            {{ repair.description
                                                ...
                                                <DropdownMenuPortal>
                                                    <transition name="fade">
                                                        <DropdownMenuContent
                                                            ...
                                                            <DropdownMenuItem>
                                                                <Link :href="route('equip.edit', repair.id)"
                                                                    class="inline-flex items-center py-1 px-2 rounded hover:bg-my-gray transition-all">
                                                                Редактировать
                                                                <svg class="block ml-2" width="16" height="16"
                                                                    viewBox="0 0 16 16" fill="none"
