        ...
        <div class="p-4 lg:p-5">
            ...
            <div v-if="selectedCategory" class="flex w-full mt-5">
                ...
                <div v-if="seriesActive" class="w-full space-y-5 lg:w-[calc(100%-100px-14px)]">
                            ...
                            <div class="min-w-[1050px] text-xs">
                                ...
                                <template v-for="item in props.equipment">
                                    <div class="flex border-b border-b-gray3 [&>*:not(:first-child)]:border-l [&>*:not(:first-child)]:border-l-gray3 break-all hover:bg-bg1">
                                        ...
                                        <Link v-if="item.directory !== null" :href="'/directory/equipment/'+item.id" class="shrink-0 flex items-center justify-center w-[45px] py-2.5 px-2">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <PopoverRoot v-else>
                                            <PopoverTrigger class="shrink-0 flex items-center justify-center w-[45px] py-2.5 px-2">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="min-w-[1050px] text-xs">
                                ...
                                <template v-for="item in props.equipment">
                                    <div class="flex border-b border-b-gray3 [&>*:not(:first-child)]:border-l [&>*:not(:first-child)]:border-l-gray3 break-all hover:bg-bg1">
                                        ...
                                        <PopoverRoot v-else>
                                            <PopoverTrigger class="shrink-0 flex items-center justify-center w-[50px] py-2.5 px-2">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M2.26884 4.51884C2.76113 4.02656 3.42881 3.75 4.125 3.75H15C15.4142 3.75 15.75 4.08579 15.75 4.5C15.75 4.91421 15.4142 5.25 15 5.25H4.125C3.82663 5.25 3.54048 5.36853 3.3295 5.5795C3.11853 5.79048 3 6.07663 3 6.375V17.625C3 17.9234 3.11853 18.2095 3.3295 18.4205C3.54048 18.6315 3.82663 18.75 4.125 18.75H19.8155C20.1138 18.75 20.4 18.6315 20.611 18.4205C20.8219 18.2095 20.9405 17.9234 20.9405 17.625V11.2031C20.9405 10.7889 21.2763 10.4531 21.6905 10.4531C22.1047 10.4531 22.4405 10.7889 22.4405 11.2031V17.625C22.4405 18.3212 22.1639 18.9889 21.6716 19.4812C21.1793 19.9734 20.5117 20.25 19.8155 20.25H4.125C3.42881 20.25 2.76113 19.9734 2.26884 19.4812C1.77656 18.9889 1.5 18.3212 1.5 17.625V6.375C1.5 5.67881 1.77656 5.01113 2.26884 4.51884Z" fill="#21272A"/>
                                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M4.65802 7.03958C4.91232 6.71262 5.38353 6.65372 5.71049 6.90802L12.0069 11.8052L15.6263 9.07314C15.9569 8.8236 16.4272 8.8893 16.6768 9.21991C16.9263 9.55051 16.8606 10.0208 16.53 10.2704L12.4519 13.3486C12.1813 13.5529 11.8072 13.5502 11.5396 13.342L4.78958 8.09205C4.46262 7.83775 4.40372 7.36654 4.65802 7.03958Z" fill="#21272A"/>
                                                    <path d="M20.2477 8.24995C21.489 8.24995 22.4953 7.24364 22.4953 6.0023C22.4953 4.76095 21.489 3.75464 20.2477 3.75464C19.0063 3.75464 18 4.76095 18 6.0023C18 7.24364 19.0063 8.24995 20.2477 8.24995Z" fill="#21272A"/>
                        ...
                        <div class="w-full max-w-full mt-2.5 bg-bg2 overflow-x-auto border border-gray3">
                            <div class="min-w-[1050px] text-xs">
                                <div class="flex font-bold border-b border-b-gray3 [&>*:not(:first-child)]:border-l [&>*:not(:first-child)]:border-l-gray3">
                                    ...
                                    <div class="shrink-0 flex items-center w-[calc(100%-14.86%-8.9%-100px)] py-2.5 px-2">Описание</div>
                                ...
                                <template v-for="repair in repairs">
                                    <div class="flex border-b border-b-gray3 [&>*:not(:last-child)]:border-r [&>*:not(:last-child)]:border-r-gray3 break-all hover:bg-bg1">
                                        ...
                                        <div class="shrink-0 flex items-center w-[calc(100%-14.86%-8.9%-100px)] py-2.5 px-2">{{ repair.description || '-' }}</div>
                                        <div class="shrink-0 flex items-center justify-center w-[8.9%] py-2.5 px-2">{{ repair.expense || '-' }} ₽</div>
                                        <div class="shrink-0 flex items-center w-[100px] py-2.5 px-2">
                                            <!--Замок открыт-->
                                            <button class="flex items-center justify-center ml-1 mr-6">
                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M4.66668 9.33334V13.3333H11.3333V9.33334H4.66668ZM10 4.66668C10 4.40403 9.94828 4.14396 9.84777 3.90131C9.74726 3.65866 9.59994 3.43818 9.41422 3.25246C9.22851 3.06675 9.00803 2.91943 8.76538 2.81892C8.52273 2.71841 8.26265 2.66668 8.00001 2.66668C7.73737 2.66668 7.47729 2.71841 7.23464 2.81892C6.99199 2.91943 6.77151 3.06675 6.5858 3.25246C6.40008 3.43818 6.25276 3.65866 6.15225 3.90131C6.05174 4.14396 6.00001 4.40403 6.00001 4.66668V8.00001H11.3333C11.687 8.00001 12.0261 8.14049 12.2762 8.39053C12.5262 8.64058 12.6667 8.97972 12.6667 9.33334V13.3333C12.6667 13.687 12.5262 14.0261 12.2762 14.2762C12.0261 14.5262 11.687 14.6667 11.3333 14.6667H4.66668C4.31305 14.6667 3.97392 14.5262 3.72387 14.2762C3.47382 14.0261 3.33334 13.687 3.33334 13.3333V9.33334C3.33334 8.97972 3.47382 8.64058 3.72387 8.39053C3.97392 8.14049 4.31305 8.00001 4.66668 8.00001V4.66668C4.66668 3.78262 5.01787 2.93478 5.64299 2.30965C6.26811 1.68453 7.11596 1.33334 8.00001 1.33334C8.88407 1.33334 9.73191 1.68453 10.357 2.30965C10.9822 2.93478 11.3333 3.78262 11.3333 4.66668C11.3333 4.84349 11.2631 5.01306 11.1381 5.13808C11.0131 5.26311 10.8435 5.33334 10.6667 5.33334C10.4899 5.33334 10.3203 5.26311 10.1953 5.13808C10.0702 5.01306 10 4.84349 10 4.66668ZM8.00001 12.6667C7.64639 12.6667 7.30725 12.5262 7.0572 12.2762C6.80715 12.0261 6.66668 11.687 6.66668 11.3333C6.66668 10.9797 6.80715 10.6406 7.0572 10.3905C7.30725 10.1405 7.64639 10 8.00001 10C8.35363 10 8.69277 10.1405 8.94282 10.3905C9.19287 10.6406 9.33334 10.9797 9.33334 11.3333C9.33334 11.687 9.19287 12.0261 8.94282 12.2762C8.69277 12.5262 8.35363 12.6667 8.00001 12.6667Z" fill="#21272A"/>
                                                </svg>
                                            </button>
                                            ...
                                            <!-- <button class="w-[50px]">
                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M4.66668 9.33334V13.3333H11.3333V9.33334H4.66668ZM11.3333 8.00001C11.687 8.00001 12.0261 8.14049 12.2762 8.39053C12.5262 8.64058 12.6667 8.97972 12.6667 9.33334V13.3333C12.6667 13.687 12.5262 14.0261 12.2762 14.2762C12.0261 14.5262 11.687 14.6667 11.3333 14.6667H4.66668C4.31305 14.6667 3.97392 14.5262 3.72387 14.2762C3.47382 14.0261 3.33334 13.687 3.33334 13.3333V9.33334C3.33334 8.97972 3.47382 8.64058 3.72387 8.39053C3.97392 8.14049 4.31305 8.00001 4.66668 8.00001V4.66668C4.66668 3.78262 5.01787 2.93478 5.64299 2.30965C6.26811 1.68453 7.11596 1.33334 8.00001 1.33334C8.88407 1.33334 9.73191 1.68453 10.357 2.30965C10.9822 2.93478 11.3333 3.78262 11.3333 4.66668V8.00001ZM10 8.00001V4.66668C10 4.40403 9.94828 4.14396 9.84777 3.90131C9.74726 3.65866 9.59994 3.43818 9.41422 3.25246C9.22851 3.06675 9.00803 2.91943 8.76538 2.81892C8.52273 2.71841 8.26265 2.66668 8.00001 2.66668C7.73737 2.66668 7.47729 2.71841 7.23464 2.81892C6.99199 2.91943 6.77151 3.06675 6.5858 3.25246C6.40008 3.43818 6.25276 3.65866 6.15225 3.90131C6.05174 4.14396 6.00001 4.40403 6.00001 4.66668V8.00001H10ZM8.00001 12.6667C7.64639 12.6667 7.30725 12.5262 7.0572 12.2762C6.80715 12.0261 6.66668 11.687 6.66668 11.3333C6.66668 10.9797 6.80715 10.6406 7.0572 10.3905C7.30725 10.1405 7.64639 10 8.00001 10C8.35363 10 8.69277 10.1405 8.94282 10.3905C9.19287 10.6406 9.33334 10.9797 9.33334 11.3333C9.33334 11.687 9.19287 12.0261 8.94282 12.2762C8.69277 12.5262 8.35363 12.6667 8.00001 12.6667Z" fill="#21272A"/>
                                                </svg>
                                            </button> -->
                                            
                                            <Link v-if="repair.directory === null" :href="'/directory/repair/'+repair.id">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M4.125 5.25C3.50368 5.25 3 5.75368 3 6.375V17.625C3 18.2463 3.50368 18.75 4.125 18.75H19.875C20.4963 18.75 21 18.2463 21 17.625V6.375C21 5.75368 20.4963 5.25 19.875 5.25H4.125ZM1.5 6.375C1.5 4.92525 2.67525 3.75 4.125 3.75H19.875C21.3247 3.75 22.5 4.92525 22.5 6.375V17.625C22.5 19.0747 21.3247 20.25 19.875 20.25H4.125C2.67525 20.25 1.5 19.0747 1.5 17.625V6.375Z" fill="#21272A"/>
                                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M4.65799 7.03955C4.91229 6.71259 5.3835 6.65369 5.71046 6.90799L12 11.7999L18.2895 6.90799C18.6165 6.65369 19.0877 6.71259 19.342 7.03955C19.5963 7.36651 19.5374 7.83772 19.2105 8.09202L12.4605 13.342C12.1896 13.5527 11.8104 13.5527 11.5395 13.342L4.78955 8.09202C4.46259 7.83772 4.40369 7.36651 4.65799 7.03955Z" fill="#21272A"/>
                                                </svg>
                    ...
                    <div>
                            ...
                            <div class="min-w-[1050px] text-xs">
                                ...
                                <template v-for="test in tests" :key="test.id">
                                    <div class="flex border-b border-b-gray3 [&>*:not(:last-child)]:border-r [&>*:not(:last-child)]:border-r-gray3 break-all hover:bg-bg1">
                                        ...
                                        <Link v-if="true" :href="'/directory/test/'+test.id" class="shrink-0 flex items-center justify-center w-[50px] py-2.5 px-2">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M4.125 5.25C3.50368 5.25 3 5.75368 3 6.375V17.625C3 18.2463 3.50368 18.75 4.125 18.75H19.875C20.4963 18.75 21 18.2463 21 17.625V6.375C21 5.75368 20.4963 5.25 19.875 5.25H4.125ZM1.5 6.375C1.5 4.92525 2.67525 3.75 4.125 3.75H19.875C21.3247 3.75 22.5 4.92525 22.5 6.375V17.625C22.5 19.0747 21.3247 20.25 19.875 20.25H4.125C2.67525 20.25 1.5 19.0747 1.5 17.625V6.375Z" fill="#21272A"/>
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M4.65799 7.03955C4.91229 6.71259 5.3835 6.65369 5.71046 6.90799L12 11.7999L18.2895 6.90799C18.6165 6.65369 19.0877 6.71259 19.342 7.03955C19.5963 7.36651 19.5374 7.83772 19.2105 8.09202L12.4605 13.342C12.1896 13.5527 11.8104 13.5527 11.5395 13.342L4.78955 8.09202C4.46259 7.83772 4.40369 7.36651 4.65799 7.03955Z" fill="#21272A"/>
                                            </svg>
                        ...
                        <div v-else class="w-full max-w-full mt-2.5 bg-bg2 overflow-x-auto border border-gray3">
                            <div class="min-w-[1050px] text-xs">
                                <div class="flex font-bold border-b border-b-gray3 [&>*:not(:first-child)]:border-l [&>*:not(:first-child)]:border-l-gray3">
                                    <div class="shrink-0 flex items-center justify-center w-[14.86%] py-2.5 px-2">Дата испытания</div>
                                    <div class="shrink-0 flex items-center w-[calc(100%-14.86%-8.9%-100px)] py-2.5 px-2">Примечание</div>
                                    <div class="shrink-0 flex items-center justify-center w-[8.9%] py-2.5 px-2">Расход</div>
                                ...
                                <template v-for="test in tests" :key="test.id">
                                    <div class="flex border-b border-b-gray3 [&>*:not(:last-child)]:border-r [&>*:not(:last-child)]:border-r-gray3 break-all">
                                        ...
                                        <div class="shrink-0 flex items-center justify-center w-[calc(14.86%-44px)] py-2.5 px-2">{{ test.test_date || '-' }}</div>
                                        <div class="shrink-0 flex items-center w-[calc(100%-14.86%-8.9%-100px)] py-2.5 px-2">{{ test.description || '-' }}</div>
                                        <div class="shrink-0 flex items-center justify-center w-[8.9%] py-2.5 px-2">{{ test.expense || '-' }} ₽</div>
                                        ...
                                        <div class="shrink-0 flex items-center w-[100px] py-2.5 px-2">
                                            ...
                                            <Link v-if="test.directory === null" :href="'/directory/tests/'+test.id">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M4.125 5.25C3.50368 5.25 3 5.75368 3 6.375V17.625C3 18.2463 3.50368 18.75 4.125 18.75H19.875C20.4963 18.75 21 18.2463 21 17.625V6.375C21 5.75368 20.4963 5.25 19.875 5.25H4.125ZM1.5 6.375C1.5 4.92525 2.67525 3.75 4.125 3.75H19.875C21.3247 3.75 22.5 4.92525 22.5 6.375V17.625C22.5 19.0747 21.3247 20.25 19.875 20.25H4.125C2.67525 20.25 1.5 19.0747 1.5 17.625V6.375Z" fill="#21272A"/>
                                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M4.65799 7.03955C4.91229 6.71259 5.3835 6.65369 5.71046 6.90799L12 11.7999L18.2895 6.90799C18.6165 6.65369 19.0877 6.71259 19.342 7.03955C19.5963 7.36651 19.5374 7.83772 19.2105 8.09202L12.4605 13.342C12.1896 13.5527 11.8104 13.5527 11.5395 13.342L4.78955 8.09202C4.46259 7.83772 4.40369 7.36651 4.65799 7.03955Z" fill="#21272A"/>
                                                </svg>
                                        ...
                                        <PopoverRoot v-else>
                                            ...
                                            <PopoverPortal>
                                                <PopoverContent side="bottom" align="end" class="w-[300px] p-4 rounded-lg text-sm bg-white shadow-lg">
                                                    ...
                                                    <Link
                                                        :href="'/directory/service/'+history_item.service.id"
                                                        class="inline-flex items-center mt-2 py-1 px-2 rounded hover:bg-my-gray transition-all"
                                                    >
                                                        Редактировать
                    ...
                    <div>
                        <h3 class="font-bold text-gray1">История перемещений</h3>

                        <div class="w-full max-w-full mt-2.5 bg-bg2 overflow-x-auto border border-gray3">
                            <div class="min-w-[1050px] text-xs">
                                <div class="flex font-bold border-b border-b-gray3 [&>*:not(:first-child)]:border-l [&>*:not(:first-child)]:border-l-gray3">
                                    <div class="shrink-0 flex items-center justify-center w-[12.14%] py-2.5 px-2">Дата отправки</div>
                                    <div class="shrink-0 flex items-center w-[10.68%] py-2.5 px-2">Откуда</div>
                                    <div class="shrink-0 flex items-center w-[10.68%] py-2.5 px-2">Куда</div>
                                    <div class="shrink-0 flex items-center w-[10.68%] py-2.5 px-2">Дата прибытия</div>
                                    <div class="shrink-0 flex items-center w-[calc(100%-12.14%-10.68%-10.68%-10.68%-8.94%-100px)] py-2.5 px-2">Причина вывоза</div>
                                    <div class="shrink-0 flex items-center w-[8.94%] py-2.5 px-2">Расход</div>
                                    <div class="shrink-0 flex items-center w-[100px] py-2.5 px-2">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M2.25 11.625C2.25 6.44782 6.44782 2.25 11.625 2.25C16.8022 2.25 21 6.44782 21 11.625C21 16.8022 16.8022 21 11.625 21C6.44782 21 2.25 16.8022 2.25 11.625ZM11.625 3.75C7.27624 3.75 3.75 7.27624 3.75 11.625C3.75 15.9738 7.27624 19.5 11.625 19.5C15.9738 19.5 19.5 15.9738 19.5 11.625C19.5 7.27624 15.9738 3.75 11.625 3.75Z" fill="#21272A"/>
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M9.5625 10.3125C9.5625 9.89829 9.89829 9.5625 10.3125 9.5625H11.8125C12.2267 9.5625 12.5625 9.89829 12.5625 10.3125V15.75C12.5625 16.1642 12.2267 16.5 11.8125 16.5C11.3983 16.5 11.0625 16.1642 11.0625 15.75V11.0625H10.3125C9.89829 11.0625 9.5625 10.7267 9.5625 10.3125Z" fill="#21272A"/>
                                ...
                                <template v-for="move in equipment_moves" :key="move.id">
                                    <div class="flex border-b border-b-gray3 [&>*:not(:last-child)]:border-r [&>*:not(:last-child)]:border-r-gray3 break-all hover:bg-bg1">
                                        ...
                                        <div class="shrink-0 flex items-center w-[10.68%] py-2.5 px-2">11.03.2024</div>
                                        <div class="shrink-0 flex items-center w-[calc(100%-12.14%-10.68%-10.68%-10.68%-8.94%-100px)] py-2.5 px-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut </div>
                                        <div class="shrink-0 flex items-center w-[8.94%] py-2.5 px-2">280 000 ₽</div>
