...
<template>
    <AuthenticatedLayout>
        ...
        <div class="container mt-5 sm:mx-auto md:mx-auto">
                    ...
                    <div class="mt-6 flex items-center sm:overflow-x-auto">
                        <ul class="flex flex-row font-medium mt-0 space-x-8 rtl:space-x-reverse text-sm">
                            <li class="text-my-nav-text text-lg w-full"
                                ...
                                <Link class="flex items-center justify-around" :href="route('equip.report', { size_id: item.id })">
                                {{ item.name }}
                                <span
                                    class="ml-1 rounded-full text-sm flex items-center px-3 py-1 text-white bg-gray-500 ">
            ...
            <div class="flex">
                <ul class="flex lg:flex md:flex sm:hidden flex-3 flex-grow mr-5 flex-col mt-10">
                ...
                <div v-if="selectedCategory == 1 && seriesActive"
                    class="flex-col sm:pb-20 lg:pt-4 sm:overflow-x-auto flex-3 ">
                    <div class="flex flex-col overflow-x-auto">
                        <h3 class="text-side-gray-text font-bold">Характеристики</h3>
                        <div class="sm:overflow-x-auto">
                            <table class=" bg-my-gray w-full mt-2 border-2 border-gray lg:table-fixed sm:table-auto ">
                                <thead class="bg-my-gray">
                                    <tr class="py-3">
                                        <th class="py-3 px-2 border text-center sm:text-sm">Производитель</th>
                                        <th class="py-3 px-2 border text-center sm:text-sm">Длина</th>
                        ...
                        <div class="lg:pt-4 sm:mt-5 sm:overflow-x-auto">
