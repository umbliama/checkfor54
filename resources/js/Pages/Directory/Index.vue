    ...
    <AuthenticatedLayout bg="gray">
        ...
        <div class="flex flex-col px-6 pb-6 lg:items-start lg:flex-row">
            ...
            <div class="grow">
                ...
                <UiNotification v-model="notification1_state" title="Изменение сохранено" description="Доп информация" />
                <UiNotification v-model="notification2_state" title="Изменение не сохранено" description="Доп информация" type="error" />
            </div>
        </div>
