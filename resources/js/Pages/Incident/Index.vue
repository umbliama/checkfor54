        ...
        <div class="p-5">
            <div class="relative flex items-center justify-between flex-col lg:flex-row">
                ...
                <ul class="relative flex items-center w-full font-medium space-x-8 overflow-x-auto lg:overflow-x-visible">
                    <li
                        :class="{ '!border-[#001D6C] text-[#001D6C]': getMenuActiveItem === 'tasks' }"
                    ...
                    <li
                        :class="{ '!border-[#001D6C] text-[#001D6C]': getMenuActiveItem === 'adv' }"
                        class="flex items-center border-b-2 border-transparent py-3 text-base lg:text-lg cursor-pointer"
                    ...
                    <li
                        :class="{ '!border-[#001D6C] text-[#001D6C]': getMenuActiveItem === 'history' || getMenuActiveItem === 'history_tasks' || getMenuActiveItem === 'history_adv' }"
                        class="flex items-center border-b-2 border-transparent py-3 text-base lg:text-lg cursor-pointer"
                                            ...
                                            >
                                                ...
                                                <svg class="shrink-0 block ml-2" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <g clip-path="url(#clip0_5001_1052)">
                                                        <path d="M14 5.33337V14H2V5.33337" stroke="#464F60" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                                        <path d="M15.3333 2H0.666626V5.33333H15.3333V2Z" stroke="#464F60" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                                        <path d="M6.66663 8H9.33329" stroke="#464F60" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                                    </g>
                                                    <defs>
                    ...
                    <div class="mt-2 space-y-2">
                        <div class="p-2 border rounded mb-2 bg-white">
                            ...
                            <div class="space-y-3">
                                <div>
                                    <UiFieldSelect
                                        :items="contragents.map(c=>({ title: c.name, value: c.id }))"
                                        label="Заказчик:"
                                        only-value
                                    />
                                </div>
                                ...
                                <div>
                                    <UiField label="Оборудование" textarea />
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <ul class="py-1 px-3 space-y-3 text-xs bg-bg1">
                                        <li class="flex items-center">
                                            Диаграмма ГТИ
                                            <svg class="shrink-0 block ml-3" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="flex justify-center mt-6 px-4 bg-bg1">
                <button type="button" class="flex items-center justify-center w-10 h-10">
                    <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M11.257 11.9999L16.207 16.9499C16.3025 17.0422 16.3787 17.1525 16.4311 17.2745C16.4835 17.3965 16.5111 17.5278 16.5122 17.6605C16.5134 17.7933 16.4881 17.925 16.4378 18.0479C16.3875 18.1708 16.3133 18.2824 16.2194 18.3763C16.1255 18.4702 16.0138 18.5445 15.8909 18.5948C15.768 18.645 15.6364 18.6703 15.5036 18.6692C15.3708 18.668 15.2396 18.6404 15.1176 18.588C14.9956 18.5356 14.8852 18.4594 14.793 18.3639L9.13599 12.7069C8.94852 12.5194 8.8432 12.2651 8.8432 11.9999C8.8432 11.7348 8.94852 11.4805 9.13599 11.2929L14.793 5.63594C14.9816 5.45378 15.2342 5.35298 15.4964 5.35526C15.7586 5.35754 16.0094 5.46271 16.1948 5.64812C16.3802 5.83353 16.4854 6.08434 16.4877 6.34654C16.4899 6.60873 16.3891 6.86133 16.207 7.04994L11.257 11.9999Z" fill="#697077"/>
                    </svg>
                </button>
                <button type="button" class="flex items-center justify-center w-10 h-10">1</button>
                <button type="button" class="flex items-center justify-center w-10 h-10 bg-white border-b border-b-gray1">2</button>
                ...
                <button type="button" class="flex items-center justify-center w-10 h-10">
                    <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M13.814 12.071L8.86399 7.12098C8.68184 6.93238 8.58104 6.67978 8.58332 6.41758C8.5856 6.15538 8.69077 5.90457 8.87618 5.71916C9.06158 5.53375 9.3124 5.42859 9.57459 5.42631C9.83679 5.42403 10.0894 5.52482 10.278 5.70698L15.935 11.364C16.1225 11.5515 16.2278 11.8058 16.2278 12.071C16.2278 12.3361 16.1225 12.5905 15.935 12.778L10.278 18.435C10.0894 18.6171 9.83679 18.7179 9.57459 18.7157C9.3124 18.7134 9.06158 18.6082 8.87618 18.4228C8.69077 18.2374 8.5856 17.9866 8.58332 17.7244C8.58104 17.4622 8.68184 17.2096 8.86399 17.021L13.814 12.071Z" fill="#697077"/>
                    </svg>
                </button>
            </div>
        </div>
