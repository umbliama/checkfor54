...
<template>
    <AuthenticatedLayout>
        <div class="p-5">
            ...
            <div class="relative flex items-center justify-between flex-col mt-5 lg:flex-row">
                <span class="absolute left-0 bottom-0 w-full h-[1px] bg-[#e5e7eb]"></span>
                <ul
                    class="relative flex items-center w-full font-medium space-x-8 overflow-x-auto lg:overflow-x-visible">
                    <li :class="{ '!border-[#001D6C] text-[#001D6C]': true }"
            ...
            <div class="grid grid-cols-1 items-start gap-5 mt-5 lg:grid-cols-3 3xl:grid-cols-4">
                                ...
                                <div v-if="block.type == 'files'">
                                    ...
                                    <ul class="py-1 px-3 space-y-3 text-xs bg-bg1">
                                        <div class="flex items-center max-w-full">
                                            <span class="grow block mr-auto text-ellipsis overflow-hidden">Название файла</span>
                ...
                <div class="p-2 bg-[#DDE1E6]">
                    ...
                    <div class="mt-2 space-y-2">
                        <div class="p-2 border rounded mb-2 bg-white">
                            <div class="mb-2 text-right text-xs">22.12.2024</div>
                            <div>
                                <div>
                                    <label class="block mb-2">Файлы:</label>
                                    <ul class="py-1 px-3 space-y-3 text-xs bg-bg1">
                                                ...
                                                >
                                                    <DropdownMenuItem>
                                                        <label
                                                            class="inline-flex items-center py-1 px-2 rounded hover:bg-my-gray transition-all cursor-pointer"
                                                        >
                                                            <input type="text" hidden multiple />
                                                            Добавить медиа
                                                        </label>
                                                    </DropdownMenuItem>
                                                    <DropdownMenuItem>
                                ...
                                <AccordionItem value="some-id">
                                    <AccordionHeader class="flex items-center justify-between px-2.5 bg-bg1">
                                        <AccordionTrigger class="shrink-0 group mr-3">
                                            ...
                                            <svg class="group-data-[state=closed]:hidden" width="24" height="24" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <span class="block w-1/3 text-center text-sm">03.02.2025</span>
                                        <span class="block w-1/3 text-center text-sm">22.12.2024</span>
                                        <DropdownMenuRoot>
                                            <DropdownMenuTrigger class="shrink-0 ml-3" aria-label="Customise options">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <DropdownMenuContent
                                                        ...
                                                        <DropdownMenuItem>
                                                            <button type="button"
                                                                ...
                                                                <svg class="block ml-2" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24">
                                                                    <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12H3m0 0l8.5-8.5M3 12l8.5 8.5"/>
                                                                </svg>
                                                            </button>
                                                        </DropdownMenuItem>
                                                    </DropdownMenuContent>
