    ...
    <div :class="[ $props.disabled ? 'opacity-60 pointer-events-none' : '' ]">
        ...
        >
            ...
            <div
                ...
                class="flex items-center justify-between w-full outline-0 px-3 lg:px-5"
            >
                {{ $props.modelValue || $props?.inpAttrs?.placeholder }}

                <svg class="shrink-0 ml-3 w-5 lg:w-6" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
