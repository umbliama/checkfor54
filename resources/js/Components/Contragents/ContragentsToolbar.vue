    ...
    <nav class="p-4 bg-my-gray">
        ...
        <div class="relative flex items-center flex-col lg:flex-row">
            ...
            <ul class="relative flex items-center w-full font-medium space-x-8 overflow-x-auto lg:overflow-x-visible">
                <li
                    :class="{ '!border-[#001D6C] text-[#001D6C]': getActiveMenuLink == 'all' }"
                    class="flex items-center border-b-2 border-transparent py-3 cursor-pointer" @click="updateMenuLink('all')"
                >
                    Все
                    <span
                ...
                <li
                    :class="{ '!border-[#001D6C] text-[#001D6C]': getActiveMenuLink == 'customers' }"
                    class="flex items-center border-b-2 border-transparent py-3 cursor-pointer" @click="updateMenuLink('customers')"
                >
                    Заказчики
                    <span
                ...
                <li
                    :class="{ '!border-[#001D6C] text-[#001D6C]': getActiveMenuLink == 'suppliers' }"
                    class="flex items-center border-b-2 border-transparent py-3 cursor-pointer" @click="updateMenuLink('suppliers')"
                >
                    Поставщики
                    <span
...
<!--                <form
            method="GET"
            class="lg:block flex items-center lg:overflow-x-visible md:overflow-x-visible sm:overflow-y-hidden sm:overflow-x-auto"
        >
            <div class="relative">
