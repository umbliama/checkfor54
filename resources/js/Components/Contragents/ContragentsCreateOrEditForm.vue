...
const form = reactive({
    ...
    commercials_incoming: props.contragent?.documents.commercials_incoming || null,
    commercials_outcoming: props.contragent?.documents.commercials_outcoming || null,
    commercials_tender: props.contragent?.documents.commercials_tender || null,
...
function submit() {
    ...
    const documentFields = ['contracts', 'commercials_incoming',
        'commercials_outcoming',
        'commercials_tender', 'transport', 'financial', 'adddocs'];
                    ...
                    <div>
                        ...
                        <ul class="mt-2 space-y-3.5 bg-my-gray">
                            <li v-if="form.commercials_incoming !== null || (props?.contragent?.documents && props.contragent.documents.some(doc => doc.type === 'commercials_incoming'))"
                                ...
                                <svg class="shrink-0 block mr-1" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                <span class="text-elipsis line-clamp-2 text-xs mr-auto"
                                ...
                                <DropdownMenuRoot v-if="contragent">
                                    <DropdownMenuTrigger>
                                        <svg class="shrink-0 ml-1" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                            ...
                                            <DropdownMenuContent
                                                ...
                                                <DropdownMenuItem>
                                                    <Link
                                                        ...
                                                        type="button"
                                                    >
                                                        <label class="inline-flex items-center py-1 px-2 rounded hover:bg-my-gray transition-all">
                                                            Открыть
                                                        </label>
                                                    </Link>
                                                </DropdownMenuItem>
                                                ...
                                                <DropdownMenuItem>
                                                    <Link
                                                        ...
                                                        type="button"
                                                    >
                                                        <label class="inline-flex items-center py-1 px-2 rounded hover:bg-my-gray transition-all text-danger">
                                                            Удалить
                                                        </label>
                                                    </Link>
                                                </DropdownMenuItem>
                    ...
                    <div>
                        ...
                        <ul class="mt-2 space-y-3.5 bg-my-gray">
                            <li v-if="form.commercials_outcoming !== null || props?.contragent?.documents.some(doc => doc.type === 'commercials_outcoming')"
                                ...
                                <svg class="shrink-0 block mr-auto" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="M6.75 3C6.35218 3 5.97064 3.15804 5.68934 3.43934C5.40804 3.72064 5.25 4.10218 5.25 4.5V19.5C5.25 19.8978 5.40804 20.2794 5.68934 20.5607C5.97064 20.842 6.35218 21 6.75 21H17.25C17.6478 21 18.0294 20.842 18.3107 20.5607C18.592 20.2794 18.75 19.8978 18.75 19.5V10.3712C18.75 10.3712 18.75 10.3711 18.75 10.3711C18.7499 10.1723 18.671 9.9817 18.5305 9.84111C18.5304 9.84109 18.5304 9.84107 18.5304 9.84105L11.9089 3.21961C11.7684 3.07905 11.5777 3.00006 11.3789 3C11.3789 3 11.3788 3 11.3788 3H6.75ZM4.62868 2.37868C5.19129 1.81607 5.95435 1.5 6.75 1.5H11.379C11.9755 1.50009 12.5476 1.73707 12.9695 2.15883L12.9695 2.15889L19.5912 8.78051C20.0129 9.20237 20.2499 9.77445 20.25 10.371V19.5C20.25 20.2956 19.9339 21.0587 19.3713 21.6213C18.8087 22.1839 18.0456 22.5 17.25 22.5H6.75C5.95435 22.5 5.19129 22.1839 4.62868 21.6213C4.06607 21.0587 3.75 20.2956 3.75 19.5V4.5C3.75 3.70435 4.06607 2.94129 4.62868 2.37868Z"
                                        fill="#697077" />
                                ...
                                <span class="text-elipsis line-clamp-2 mr-auto text-xs" v-if="form.commercials_outcoming">{{ file.name }}</span>
                                <span class="text-elipsis line-clamp-2 mr-auto text-xs" v-else>{{ file.file_path.split('/').pop() }}</span>
                                <DropdownMenuRoot v-if="contragent">
                                    <DropdownMenuTrigger>
                                        <svg class="shrink-0 ml-1" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div>
                        ...
                        <ul class="mt-2 space-y-3.5 bg-my-gray">
                            <li v-if="form.commercials_tender !== null || props?.contragent?.documents.some(doc => doc.type === 'commercials_tender')"
                                ...
                                <span class="text-elipsis line-clamp-2 mr-auto text-xs" v-if="form.commercials_tender">{{ file.name }}</span>
                                <span class="text-elipsis line-clamp-2 mr-auto text-xs" v-else>{{ file.file_path.split('/').pop() }}</span>
                                <DropdownMenuRoot v-if="contragent">
                                    <DropdownMenuTrigger>
                                        <svg class="shrink-0 ml-1" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <DropdownMenuContent
                                            ...
                                            <DropdownMenuItem>
                                                <label
                                                    ...
                                                    Загрузить
                                                    <input type="file" multiple
                                                        @change="handleFileUpload($event, 'commercials_tender')" hidden>
                                                </label>
                                            </DropdownMenuItem>
                                        </DropdownMenuContent>
                                    </transition>
            ...
            <div class="py-4 px-2 content-block">
                ...
                <ul class="mt-2 space-y-3.5 bg-my-gray">
                    <li v-if="form.contracts !== null || props?.contragent?.documents.some(doc => doc.type === 'contracts')"
                        ...
                        <span class="text-elipsis line-clamp-2 mr-auto text-xs" v-if="form.contracts">{{ file.name }}</span>
                        <span class="text-elipsis line-clamp-2 mr-auto text-xs" v-else>{{ file.file_path.split('/').pop() }}</span>
                        <DropdownMenuRoot v-if="contragent">
                            <DropdownMenuTrigger>
                                <svg class="shrink-0 ml-1" width="24" height="24" viewBox="0 0 24 24" fill="none"
            ...
            <div class="py-4 px-2 content-block">
                ...
                <ul class="mt-2 space-y-3.5 bg-my-gray">
                    <li v-if="form.transport !== null || props?.contragent?.documents.some(doc => doc.type === 'transport')"
                        ...
                        <span class="text-ellipsis line-clamp-2 mr-auto text-xs" v-if="form.transport">{{ file.name }}</span>
                        <span class="text-ellipsis line-clamp-2 mr-auto text-xs" v-else>{{ file.file_path.split('/').pop() }}</span>
                        <DropdownMenuRoot v-if="contragent">
                            <DropdownMenuTrigger>
                                <svg class="shrink-0 ml-1" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="py-4 px-2 content-block">
                ...
                <ul class="mt-2 space-y-3.5 bg-my-gray">
                    <li v-if="form.financial !== null || props?.contragent?.documents.some(doc => doc.type === 'financial')"
                        ...
                        <span class="text-ellipsis line-clamp-2 mr-auto text-xs" v-if="form.financial">{{ file.name }}</span>
                        <span class="text-ellipsis line-clamp-2 mr-auto text-xs" v-else>{{ file.file_path.split('/').pop() }}</span>
                        <DropdownMenuRoot v-if="contragent">
                            <DropdownMenuTrigger>
                                <svg class="shrink-0 ml-1" width="24" height="24" viewBox="0 0 24 24" fill="none"
            ...
            <div class="py-4 px-2 content-block">
                ...
                <ul class="mt-2 space-y-3.5 bg-my-gray">
                    <li v-if="form.adddocs !== null || props?.contragent?.documents.some(doc => doc.type === 'adddocs')"
                        ...
                        <span class="text-ellipsis line-clamp-2 mr-auto text-xs" v-if="form.adddocs">{{ file.name }}</span>
                        <span class="text-ellipsis line-clamp-2 mr-auto text-xs" v-else>{{ file.file_path.split('/').pop() }}</span>
                        <DropdownMenuRoot v-if="contragent">
                            <DropdownMenuTrigger>
                                <svg class="shrink-0 ml-1" width="24" height="24" viewBox="0 0 24 24" fill="none"
