    ...
    <div class="flex flex-wrap lg:flex-nowrap">
        ...
        <div class="hidden w-1/4 lg:block">
            ...
            <div class="content-block">
                <ul class="p-2">
                    <Link v-if="props.contragent" :href="route('contragents.show', props.contragent.id)" class="block py-3 px-2 font-medium cursor-pointer">
                        Просмотр
                    </Link>
                ...
                <div class="p-4 content-block">
                    <template v-if="getActiveTab == 'profile'">
                        ...
                        <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                            ...
                            <UiField
                                v-model="form.notes"
                                :inpAttrs="{ placeholder: 'текст примечания' }"
                                label="Примечание"
                                @blur="updateForm"
                            />
                            <UiField
                            ...
                            <UiField
                                ...
                                :inpAttrs="{ placeholder: 'текст комментария' }"
                                label="Комментарий"
                                class="lg:col-span-2"
                                @blur="updateForm"
                                textarea
                    ...
                    <template v-if="getActiveTab == 'bank'">
                        ...
                        <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                            <UiField
                                ...
                                :inpAttrs="{ placeholder: 'Отделение Банка № 1234 ' }"
                            ...
                            <UiField
                                ...
                                :inpAttrs="{ placeholder: '00000000000000000000' }"
                    ...
                    <template v-if="getActiveTab == 'contacts'">
                        ...
                        <div class="grid grid-cols-1 gap-4 lg:grid-cols-6">
                            <UiField
                                ...
                                :inpAttrs="{ placeholder: 'индекс, город, улица, номер строения.' }"
                                label="Адрес"
                            ...
                            <UiField
                                v-model="form.site"
                                :inpAttrs="{ placeholder: 'www.site.ru' }"
                                label="Сайт"
                                class="col-span-1 lg:col-span-2"
                                @blur="updateForm"
                            />
                            ...
                            <UiField
                                ...
                                :inpAttrs="{ placeholder: 'Имя Фамилия' }"
            ...
            <div class="py-4 px-2 content-block">
                ...
                <ul class="mt-2 space-y-3.5 bg-my-gray">
                    <li class="flex items-center">
                        ...
                        <div class="grow mx-1 text-xs">Документы на заказчика</div>
                    </li>
                </ul>
                <div class="flex items-center justify-between mt-2">
                    <ul class="flex -space-x-2">
            ...
            <div class="py-4 px-2 content-block">
                ...
                <ul class="mt-2 space-y-3.5 bg-my-gray">
                    <li class="flex items-center">
                        ...
                        <div class="grow mx-1 text-xs">Акт приема-передачи</div>
                    </li>
                </ul>
                <div class="flex items-center justify-between mt-2">
                    <ul class="flex -space-x-2">
