...
const totalPages = computed(() => store.getters['pagination/totalPages']);
...
<template>
    <div v-if="links.length > 2"
        ...
        <div class=" flex items-center">
            ...
            <select  id="itemsPerPage" @change="changeItemsPerPage" class="border-none bg-transparent focus:none">
