    ...
    <nav class="p-4 bg-my-gray">
        <div class="relative flex items-center flex-col lg:flex-row">
            ...
            <div class="flex w-full mt-4 lg:w-auto lg:mt-0">
                <UiFieldDate v-model="start_date" :inp-attrs="{ placeholder: 'Дата начала', class: 'bg-white' }" class="w-[calc(100%/2-12px)] lg:w-[178px]" />
                <button
                ...
                <UiFieldDate v-model="end_date" :inp-attrs="{ placeholder: 'Дата завершения', class: 'bg-white' }" class="w-[calc(100%/2-12px)] lg:w-[178px]" />
            </div>
        </div>
    </nav>
</template>
