...
const $props = defineProps({
    countServicesActive  : Number,
    countServicesInactive: Number,
});
...
const selectActive = value => store.dispatch('services/updateSelectedActive', value);
    ...
    <nav class="p-4 bg-my-gray">
        <div class="relative flex items-center flex-col lg:flex-row">
            ...
            <ul class="relative flex items-center w-full font-medium space-x-8 overflow-x-auto lg:overflow-x-visible">
                <li
                    :class="{ '!border-[#001D6C] text-[#001D6C]': selectedActive }"
                                    ...
                                    <DropdownMenuItem>
                                        ...
                                        >
                                            ...
                                            <svg class="block ml-2" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M8.75 2.75003C8.75 2.33582 8.41421 2.00003 8 2.00003C7.58578 2.00003 7.25 2.33582 7.25 2.75003V7.25H2.75001C2.33579 7.25 2.00001 7.58578 2.00001 8C2.00001 8.41421 2.33579 8.75 2.75001 8.75H7.25L7.25001 13.25C7.25001 13.6642 7.58579 14 8.00001 14C8.41422 14 8.75001 13.6642 8.75001 13.25L8.75 8.75H13.25C13.6642 8.75 14 8.41421 14 8C14 7.58578 13.6642 7.25 13.25 7.25H8.75V2.75003Z" fill="#464F60"/>
                                            </svg>
                                        </Link>
                                    </DropdownMenuItem>
                                </DropdownMenuContent>
            ...
            <div class="flex">
                <UiFieldDate v-model="start_date" :inp-attrs="{ placeholder: 'Дата начала', class: 'bg-white' }" class="w-[178px]" />
                <button class="flex items-center justify-center w-12 h-12 bg-[#DDE1E6] text-gray1" @click="reset">
                ...
                <UiFieldDate v-model="end_date" :inp-attrs="{ placeholder: 'Дата завершения', class: 'bg-white' }" class="w-[178px]" />
            </div>
        </div>
    </nav>
</template>
